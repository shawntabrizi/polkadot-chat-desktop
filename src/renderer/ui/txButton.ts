 ...
 * press only opens the signing strip.
 */
...
export type TxButtonView = {
  /** "1 PAS", from `display.amount` and `display.asset`; null without an amount. */
  caption: string | null;
  expired: boolean;
  tooltip: string;
};
